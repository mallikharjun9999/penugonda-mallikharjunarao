                ...
                <Card className="glass-card animated-card card-gradient-1 animate-card-float">
                  <CardContent className="p-6 sm:p-8">
                    ...
                    <p className="text-muted-foreground leading-relaxed mb-6 text-sm sm:text-base">
                      ...
                      complex technology and practical learning. I believe in making application development accessible
                      to everyone through hands-on projects and real-world applications.
                    </p>
                    <div className="flex items-center gap-2 text-primary">
                      <Users className="w-4 h-4 sm:w-5 sm:h-5" />
                      <span className="font-semibold text-sm sm:text-base">1000+ students taught</span>
                    </div>
                  </CardContent>
                </Card>
              </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 max-w-5xl mx-auto mb-8 sm:mb-12">
            <Card className="text-center glass-card animated-card card-gradient-1 animate-pulse-glow">
              <CardContent className="p-4 sm:p-6">
                ...
                <div className="text-xs sm:text-sm text-muted-foreground">Technologies Taught</div>
              </CardContent>
            </Card>
            ...
            <Card className="text-center glass-card animated-card card-gradient-4 animate-pulse-glow" style={{ animationDelay: '1.5s' }}>
              <CardContent className="p-4 sm:p-6">
                ...
                <div className="text-4xl sm:text-5xl md:text-6xl font-bold text-primary mb-1 sm:mb-2 leading-none">∞</div>
